...
<div class="col-md-10">
<div class="card">
	<div class="card-header" style="background-color:#dddddd;"><h3>FORM PENDAFTARAN KARTU KELUARGA</h3></div>
...
<div class="col-lg-6">
  <input type="text" class="form-control form-control-lg" name="almtkk" value="" id="almtkk" placeholder="Alamat">
</div>
</div>
<div class="form-group">
<div class="col-lg-2">
  <input type="text" class="form-control form-control-lg" name="kodepos" value="" id="kodepos" placeholder="Kodepos">
</div>
<div class="col-lg-1">
  <input type="text" class="form-control form-control-lg" name="rt" value="" id="rt" placeholder="RT">
</div>
<div class="col-lg-1">
  <input type="text" class="form-control form-control-lg" name="rw" value="" id="rw" placeholder="RW">
</div>
<div class="col-lg-2">
  <input type="text" class="form-control form-control-lg" name="jmlorg" value="" id="jmlorg" placeholder="Jml. Orang">
</div>
<div class="col-lg-4">
  <input type="text" class="form-control form-control-lg" name="tlpkk" value="" id="tlpkk" placeholder="Telepon">
</div>
</div>
...
<div class="card">
	<div class="card-header" style="background-color:#d6e9c6;" text-white><h3>DATA KELUARGA</h3></div>
  <div class="panel-body">
    
 <div class="form-group">
 <div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 1">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-2">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="No.KTP">
</div>
<div class="col-lg-2">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Almt. Sebelumnya">
</div>
<div class="col-lg-2">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="No.Paspor">
</div>
<div class="col-lg-2">
<input class="form-control form-control-lg" id="tlbayi" name="tlbayi" placeholder="TGL/BULAN/TAHUN" type="text"/>
</div>
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 2">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 3">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 4">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 5">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 6">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 7">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 8">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 9">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
...
<div class="col-lg-3">
  <input type="text" class="form-control form-control-lg" name="namabayi" value="" id="namabayi" placeholder="Anggota Keluarga 10">
</div>
<div class="col-lg-1">
  <select class="form-control form-control-lg" name="jkpelapor">
  <option value="-" selected>- Gelar -</option>
