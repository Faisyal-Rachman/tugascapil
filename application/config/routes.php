 ...
 */
$route['default_controller'] = 'mendaftaranggota';
...
// Products urls style
$route['kedai-online-(:any)'] = "mendaftaranggota";
$route['(:any)_(:num)'] = "mendaftaranggota/viewProduct/$2";
$route['listkota'] = "mendaftaranggota/listKota";
$route['daftar_kartu_anggota'] = "mendaftaranggota/daftarkta";
$route['daftar_akta_lahirweb'] = "mendaftaranggota/daftaraktaweb";
$route['update_kartu_anggota'] = "mendaftaranggota/updatekta";
$route['update_kartu_anggotaweb'] = "mendaftaranggota/updatektaweb";
$route['sendmail'] = "mendaftaranggota/send_message";
$route['baca/(:any)_(:num)'] = "mendaftaranggota/viewInfo/$2";
$route['(\w{2})/(:any)_(:num)'] = "home/viewProduct/$3";
$route['shop-product_(:num)'] = "home/viewProduct/$3";

// Galeri urls style
//$route['informasiseputartarakan/(:num)'] = "kedai_online_tarakan/informasiseputartarakan/$1";
$route['(\w{2})/(:any)_(:num)'] = "home/viewGaleri/$3";
$route['shop-galeri_(:num)'] = "home/viewGaleri/$3";
...
$route['shop'] = "bhome/shop";
$route['(\w{2})/shop'] = "bhome/shop";
 ...
 */
// HOME / LOGIN
$route['admin'] = "admin/daftarisri/login";
// ECOMMERCE GROUP
...
// SETTINGS GROUP
$route['admin/logout'] = "admin/daftarisri/beranda/logout";
...
$route['admin/siswa'] = "admin/advanced_settings/siswa";
$route['admin/slider'] = "admin/advanced_settings/slider";
$route['admin/newgaleri/(:num)'] = "admin/advanced_settings/newgaleri/index/$1";
$route['admin/newgaleri'] = "admin/advanced_settings/newgaleri";
$route['admin/galeri'] = "admin/advanced_settings/galeri";
$route['admin/galeri/(:num)'] = "admin/advanced_settings/galeri/index/$1";
$route['admin/newsiswa/(:num)'] = "admin/advanced_settings/newsiswa/index/$1";
$route['admin/newsiswa'] = "admin/advanced_settings/newsiswa";
$route['admin/siswa'] = "admin/advanced_settings/siswa";
$route['admin/anggota'] = "admin/advanced_settings/anggota";
$route['admin/siswa/(:num)'] = "admin/advanced_settings/siswa/index/$1";
