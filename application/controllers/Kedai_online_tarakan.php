...
class Mendaftaranggota extends MY_Controller
{
    ...
    public function daftarktaweb()
    {
        ...
        $arr = array(
         ...
         //      $this->sendNotifications();   
          ...
          $this->db->insert('kta', $arr);
          $this->session->set_userdata($arr);
        $this->render('detailpendaftaranweb', $head, $data, $arr);
    }
    ...
    $listmail = array($to_email, 'websitetarakan@gmail.com');
        ...
        $this->email->message('Coba mengirim Email dengan CodeIgniter.<br>'.$_POST['password']); 
