                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div id="navbar" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="<?= base_url() ?>" target="_blank"><i class="glyphicon glyphicon-star"></i>Tampilkan</a></li>
                                <li>
                                    <a href="javascript:void(0);" class="h-settings"><i class="fa fa-key" aria-hidden="true"></i> Ubah Password</a>
                                    <div class="relative">
                                        <div class="settings">
                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li><a href="<?= base_url('admin/galeri') ?>" <?= urldecode(uri_string()) == 'admin/galeri' ? 'class="active"' : '' ?>><i class="fa fa-th" aria-hidden="true"></i>Galeri Berita</a></li>
                                    <li><a href="<?= base_url('admin/adminusers') ?>" <?= urldecode(uri_string()) == 'admin/adminusers' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> Admin Users</a></li>
                                     <li><a href="<?= base_url('admin/anggota') ?>" <?= urldecode(uri_string()) == 'admin/siswa' ? 'class="active"' : '' ?>><i class="fa fa-users" aria-hidden="true"></i> Akta Kelahiran</a></li>
